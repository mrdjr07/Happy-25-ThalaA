...
<button 
onclick="playSound(sounds.finally,0.7); showBirthdaySurprise();"
...
if (attempts < 50) {
    ...
    console.log("Button moving...");
        ...
        // After 50 attempts, stop escaping
if (attempts >= 50) {
...
do {
    ...
    x = Math.random() *
        (window.innerWidth - noBtn.offsetWidth - padding * 2) + padding;

    y = Math.random() *
        (window.innerHeight - noBtn.offsetHeight - padding * 2) + padding;

} while (

    x < yesBtn.offsetLeft + yesBtn.offsetWidth + 20 &&
    x + noBtn.offsetWidth > yesBtn.offsetLeft - 20 &&
    y < yesBtn.offsetTop + yesBtn.offsetHeight + 20 &&
    y + noBtn.offsetHeight > yesBtn.offsetTop - 20
